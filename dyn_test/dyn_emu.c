...
//Pels moviment per prints que mostri quan s'ha escrit en la posició que fa que és mogui
//un missatge tal com "Moven endevan a X velocitat"
//Sensors -> modificaria el codi per tal que la memoria contingui en la posició dels sensors
//uns valors determinats i després comprovar en el main que és llegeix el valor correcte.
#include "dyn_emu.h"
